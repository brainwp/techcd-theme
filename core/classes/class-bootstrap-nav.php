...
class Odin_Bootstrap_Nav_Walker extends Walker_Nav_Menu {
	...
	public function start_lvl( &$output, $depth = 0, $args = array() ) {
		...
		$output .= "\n$indent<ul role=\"menu\" class=\" sub curved\">\n";
	}
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( strcasecmp( $item->attr_title, 'divider' ) == 0 && $depth === 1 ) {
			...
			$item_output .= $args->link_before . '<span class="menu_span">' .apply_filters( 'the_title', $item->title, $item->ID ) . '</span>' . $args->link_after;
			$item_output .= '</a>';
	...
	public static function fallback( $args ) {
		if ( current_user_can( 'manage_options' ) ) {
			...
			$fb_output .= '>';
			$fb_output .= '<li><a href="' . admin_url( 'nav-menus.php' ) . '">' . __( 'Add a menu', 'techcd-theme' ) . '</a></li>';
			$fb_output .= '</ul>';
