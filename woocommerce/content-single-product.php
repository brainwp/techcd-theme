...
<?php
$slider_meta = get_post_meta( get_the_ID(), '_product_image_gallery', true );
$slider = explode(',', $slider_meta);
if(!empty($slider_meta)){
	...
	$html = '<div class="col-md-12 is_slider" id="slider-woo-product">';
	$img = wp_get_attachment_image_src( get_post_thumbnail_id(get_the_ID()), 'brasa_slider_img', false );
	$html .= '<div class="slick_slide">';
	//$html .= '<a href="#"><img src="'.$img[0].'" class="img_slider"></a>';
	$html .= '<img src="'.$img[0].'" class="img_slider">';
	$html .= '</div>';
